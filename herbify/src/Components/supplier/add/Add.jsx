        ...
        <div className="sellProductCont container">
            <div className="card shadow mb-1">
                ...
                <div className="sellProductHeader card-header py-3">
                    <h4 className="sellProductTitle " ><b>Add Product</b></h4>
                </div>
                <form  >
                        ...
                        <div className="mb-3">
                            ...
                            <div >
                                ...
                                <div className="form-group">
                                    ...
                                    <label for="cover" className="sellProductLable">Select Cover Image</label>
                                    <input type="file" className="form-control" name="cover" aria-describedby="emailHelp" required  ></input>
                                    ...
                                    <label for="shortDesc" className="sellProductLable">Delivery Time (e.g. 4 days)</label>
                                    <input type="number" className="form-control" name="shortDesc" aria-describedby="emailHelp" placeholder="Enter Delivery Dates" ></input>
